#!/bin/bash
# Build script for Phase 2 - Partition Boundary Debug Tool

set -e

echo "════════════════════════════════════════════════════════════"
echo "  Building Partition Boundary Debug Tool"
echo "════════════════════════════════════════════════════════════"
...
# Compile dependencies if not exist
...
echo "[7/7] Linking debug_partition_boundary..."
${NVCC} ${COMMON_FLAGS} ${CUDA_FLAGS} ${DEFINES} \
    src/opt/phase2_large_partition/debug_partition_boundary.cpp \
    bin/L3_codec.o \
    bin/encoder.o \
    ...
    -o bin/debug_partition_boundary \
    -L${CUDA_PATH}/lib64 -lcudart

echo ""
echo "✅ Build complete!"
echo "   Executable: bin/debug_partition_boundary"
echo ""
echo "Run with:"
echo "  ./bin/debug_partition_boundary"
echo ""
