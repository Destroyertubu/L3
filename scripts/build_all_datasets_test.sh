#!/bin/bash
# Build script for All Datasets Test (Phase 2.2)

set -e

echo "════════════════════════════════════════════════════════════"
echo "  Building All Datasets Test (Phase 2.2 Bucket Scheduler)"
echo "════════════════════════════════════════════════════════════"
...
# Reuse existing object files if available
...
echo "[7/7] Linking test_all_datasets_phase2..."
${NVCC} ${COMMON_FLAGS} ${CUDA_FLAGS} ${DEFINES} \
    src/test_all_datasets_phase2.cpp \
    bin/L3_codec.o \
    bin/encoder.o \
    ...
    -o bin/test_all_datasets_phase2 \
    -L${CUDA_PATH}/lib64 -lcudart

echo ""
echo "✅ Build complete!"
echo "   Executable: bin/test_all_datasets_phase2"
echo ""
echo "Run with:"
echo "  ./bin/test_all_datasets_phase2"
echo ""
echo "Results will be saved to: benchmark_results_all_datasets.csv"
echo ""
