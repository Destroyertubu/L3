#!/bin/bash
# Build script for Phase 2.3 - T1: Large Partition Size Optimization

set -e

echo "════════════════════════════════════════════════════════════"
echo "  Building T1: Large Partition Size Test"
echo "════════════════════════════════════════════════════════════"
...
# T1 specific: No kernel changes, just testing larger partitions
...
echo "  T1: Large partition size (configured in test)"
echo ""
...
echo "[7/7] Linking test_v1_large_partition..."
${NVCC} ${COMMON_FLAGS} ${CUDA_FLAGS} ${DEFINES} \
    src/decode/test_v1_large_partition.cpp \
    bin/L3_codec.o \
    bin/encoder.o \
    ...
    -o bin/test_v1_large_partition \
    -L${CUDA_PATH}/lib64 -lcudart

echo ""
echo "✅ Build complete!"
echo "   Executable: bin/test_v1_large_partition"
echo ""
echo "Run with:"
echo "  ./bin/test_v1_large_partition"
echo ""
