...
echo "Building baseline 16K test..."
...
CUDA_FLAGS="${CUDA_FLAGS} --expt-relaxed-constexpr -Xcompiler -fPIC"
...
${NVCC} ${COMMON_FLAGS} ${CUDA_FLAGS} ${DEFINES} \
    src/opt/phase2_large_partition/test_baseline_16k.cpp \
    bin/L3_codec.o \
    bin/encoder.o \
    ...
    -o bin/test_baseline_16k \
    -L${CUDA_PATH}/lib64 -lcudart

echo "✅ Build complete: bin/test_baseline_16k"
