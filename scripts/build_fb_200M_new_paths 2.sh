...
# Compile with new paths
echo "[1/7] Compiling bitpack_utils.cu..."
${NVCC} ${COMMON_FLAGS} ${CUDA_FLAGS} ${DEFINES} \
    -c src/kernels/utils/bitpack_utils.cu -o bin/bitpack_utils_bucket.o
...
echo "[7/7] Linking test_fb_200M_reorganized_v2..."
${NVCC} ${COMMON_FLAGS} ${CUDA_FLAGS} ${DEFINES} \
    ...
    -o bin/test_fb_200M_reorganized_v2 \
