...
int _kTCountDistinctImplTypeValues[] = {
  ...
  TCountDistinctImplType::UnorderedSet
};
...
const std::map<int, const char*> _TAggKind_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(10, _kTAggKindValues, _kTAggKindNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
void TResultSetBufferDescriptor::__set_gpu_shared_mem_used(const bool val) {
  this->gpu_shared_mem_used = val;
}
...
uint32_t TResultSetBufferDescriptor::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 14:
        if (ftype == ::apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->gpu_shared_mem_used);
          this->__isset.gpu_shared_mem_used = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t TResultSetBufferDescriptor::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("gpu_shared_mem_used", ::apache::thrift::protocol::T_BOOL, 14);
  xfer += oprot->writeBool(this->gpu_shared_mem_used);
  xfer += oprot->writeFieldEnd();
...
void swap(TResultSetBufferDescriptor &a, TResultSetBufferDescriptor &b) {
  ...
  swap(a.gpu_shared_mem_used, b.gpu_shared_mem_used);
  swap(a.__isset, b.__isset);
}
...
TResultSetBufferDescriptor::TResultSetBufferDescriptor(const TResultSetBufferDescriptor& other45) {
  ...
  gpu_shared_mem_used = other45.gpu_shared_mem_used;
...
TResultSetBufferDescriptor& TResultSetBufferDescriptor::operator=(const TResultSetBufferDescriptor& other46) {
  ...
  gpu_shared_mem_used = other46.gpu_shared_mem_used;
...
void TResultSetBufferDescriptor::printTo(std::ostream& out) const {
  ...
  out << ", " << "gpu_shared_mem_used=" << to_string(gpu_shared_mem_used);
  out << ")";
}
