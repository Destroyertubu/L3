...
class HeavyHandler : virtual public HeavyIf {
 public:
  HeavyHandler() {
  ...
  void set_cur_session(const TSessionId& parent_session, const TSessionId& leaf_session, const std::string& start_time_str, const std::string& label, const bool for_running_query_kernel) {
    // Your implementation goes here
    printf("set_cur_session\n");
  }

  void invalidate_cur_session(const TSessionId& parent_session, const TSessionId& leaf_session, const std::string& start_time_str, const std::string& label, const bool for_running_query_kernel) {
    // Your implementation goes here
  ...
  void get_queries_info(std::vector<TQueryInfo> & _return, const TSessionId& session) {
    // Your implementation goes here
    printf("get_queries_info\n");
  }

  void set_leaf_info(const TSessionId& session, const TLeafInfo& leaf_info) {
    // Your implementation goes here
    printf("set_leaf_info\n");
  }
  ...
  void create_table(const TSessionId& session, const std::string& table_name, const TRowDescriptor& row_desc, const TCreateParams& create_params) {
    // Your implementation goes here
    printf("create_table\n");
  }
  ...
  void get_all_effective_roles_for_user(std::vector<std::string> & _return, const TSessionId& session, const std::string& userName) {
    // Your implementation goes here
    printf("get_all_effective_roles_for_user\n");
  }
  ...
  void get_table_function_names(std::vector<std::string> & _return, const TSessionId& session) {
    // Your implementation goes here
    printf("get_table_function_names\n");
  }

  void get_runtime_table_function_names(std::vector<std::string> & _return, const TSessionId& session) {
    // Your implementation goes here
    printf("get_runtime_table_function_names\n");
  }

  void get_table_function_details(std::vector< ::TUserDefinedTableFunction> & _return, const TSessionId& session, const std::vector<std::string> & udtf_names) {
    // Your implementation goes here
    printf("get_table_function_details\n");
  }

  void get_function_names(std::vector<std::string> & _return, const TSessionId& session) {
    // Your implementation goes here
    printf("get_function_names\n");
  }

  void get_runtime_function_names(std::vector<std::string> & _return, const TSessionId& session) {
    // Your implementation goes here
    printf("get_runtime_function_names\n");
  }

  void get_function_details(std::vector< ::TUserDefinedFunction> & _return, const TSessionId& session, const std::vector<std::string> & udf_names) {
    // Your implementation goes here
    printf("get_function_details\n");
  }

  void put_immerse_users_metadata(const TSessionId& session, const std::vector<TImmerseUserMetadata> & immerse_user_metadata_list) {
    // Your implementation goes here
    printf("put_immerse_users_metadata\n");
  }

  void put_immerse_database_metadata(const TSessionId& session, const std::string& immerse_metadata_json, const std::string& database_name) {
    // Your implementation goes here
    printf("put_immerse_database_metadata\n");
  }

  void get_users_info(std::vector<TUserInfo> & _return, const TSessionId& session) {
    // Your implementation goes here
    printf("get_users_info\n");
  }
...
int main(int argc, char **argv) {
  int port = 9090;
  ::std::shared_ptr<HeavyHandler> handler(new HeavyHandler());
  ::std::shared_ptr<TProcessor> processor(new HeavyProcessor(handler));
