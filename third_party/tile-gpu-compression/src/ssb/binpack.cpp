...
int main(int argc, char** argv) {
  ...
  // Auto-detect table size based on column name prefix
  if (col_name[0] == 'p') len = P_LEN;
  else if (col_name[0] == 's') len = S_LEN;
  else if (col_name[0] == 'c') len = C_LEN;
  else if (col_name[0] == 'd') len = D_LEN;
