...
public:
	...
	static constexpr int32_t lo_orderdate_min = 19920101;
	static constexpr int32_t lo_orderdate_max = 19981228;
	static constexpr uint8_t lo_orderdate_bw  = 16;

	static constexpr int32_t lo_extendedprice_min = 90000;
	static constexpr int32_t lo_extendedprice_max = 9999999;
	static constexpr uint8_t lo_extendedprice_bw  = 24;
	...
	static constexpr int32_t lo_discount_min = 0;
	static constexpr int32_t lo_discount_max = 10;
	static constexpr uint8_t lo_discount_bw  = 4;
	...
	static constexpr uint8_t lo_real_suppkey_bw   = 16;
	static constexpr uint8_t lo_chosen_suppkey_bw = 16;

	static constexpr int32_t lo_revenue_min = 0;
	static constexpr int32_t lo_revenue_max = 9999999;
	static constexpr uint8_t lo_revenue_bw  = 24;

	static constexpr int32_t lo_custkey_min       = 1;
	static constexpr int32_t lo_custkey_max       = 600000;
	static constexpr uint8_t lo_real_custkey_bw   = 20;
	static constexpr uint8_t lo_chosen_custkey_bw = 20;

	static constexpr int32_t lo_supplycost_min       = 50000;
	static constexpr int32_t lo_supplycost_max       = 199999;
	static constexpr uint8_t lo_supplycost_bw        = 18;
	static constexpr uint8_t lo_chosen_supplycost_bw = 20;
...
inline SSB ssb_20 {119968352, "SF_20", sample_data::ssb_20::lineorder_dir, 117157};
...
// SF=20 query results (placeholder - will be computed at runtime)
inline SSBQuery1 ssb_q11_20 {0, ssb_20};
inline SSBQuery1 ssb_q12_20 {0, ssb_20};
inline SSBQuery1 ssb_q13_20 {0, ssb_20};
...
// C++17 compatible bit_width implementation
inline int bit_width_impl(uint32_t x) {
	if (x == 0) return 0;
	int bits = 0;
	while (x > 0) {
		x >>= 1;
