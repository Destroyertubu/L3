/**
 * @file q33_fused_v5.cu
 * @brief SSB Q3.3 with L3 Native Format + Prefetch Strategy
 *
 * Query:
...
__global__ void q33_fused_v5_kernel(
...
void runQ33FusedV5(SSBDataCompressedVertical& data) {
    ...
    for (int i = 0; i < 5; i++) {
        ...
        q33_fused_v5_kernel<<<num_tiles, WARP_SZ>>>(
...
int main(int argc, char** argv) {
    ...
    std::cout << "======================================================" << std::endl;
    std::cout << "SSB Q3.3 - L3 Native Format + Prefetch Strategy (V5)" << std::endl;
    std::cout << "======================================================" << std::endl;
