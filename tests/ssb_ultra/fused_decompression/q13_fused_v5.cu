/**
 * @file q13_fused_v5.cu
 * @brief SSB Q1.3 with L3 Native Format + Prefetch Strategy
 *
 * Query:
 ...
 *   - Year: Week 6 of 1994 (Feb 7-13: 19940207-19940213)
 *   - Discount: 5-7
 *   - Quantity: 26-35
 */
...
// ============================================================================
// Main Fused Kernel V5 - Q1.3
// ============================================================================

__global__ void q13_fused_v5_kernel(
    ...
    unsigned long long* __restrict__ revenue)
{
    ...
    for (int mv = 0; mv < 4; mv++) {
        ...
        // Filter: Week 6 of 1994 (Feb 7-13: 19940207 <= orderdate <= 19940213)
        #pragma unroll
        for (int v = 0; v < 8; v++) {
            if (flags[v]) {
                flags[v] = (orderdate[v] >= 19940207u && orderdate[v] <= 19940213u);
            }
        }
        ...
        for (int v = 0; v < 8; v++) {
            if (flags[v]) {
                flags[v] = (discount[v] >= 5u && discount[v] <= 7u);
            }
        }
...
void runQ13FusedV5(ssb::SSBDataCompressedVertical& data) {
    ...
    for (int i = 0; i < 5; i++) {
        ...
        q13_fused_v5_kernel<<<num_tiles, WARP_SZ>>>(
...
int main(int argc, char** argv) {
    ...
    std::cout << "======================================================" << std::endl;
    std::cout << "SSB Q1.3 - L3 Native Format + Prefetch Strategy (V5)" << std::endl;
    std::cout << "======================================================" << std::endl;
    std::cout << "Filters: Week 6 of 1994 (Feb 7-13), discount 5-7, quantity 26-35" << std::endl;
    std::cout << std::endl;
