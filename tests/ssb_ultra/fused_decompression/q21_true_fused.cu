/**
 * @file q21_true_fused.cu
 * @brief SSB Q2.1 Implementation - OPTIMIZED True Fused Decompression
 *
 * Query:
...
// ============================================================================
// Optimized Q2.1 Kernel with Thread Coarsening and Two-Level Hash
// ============================================================================

__global__ __launch_bounds__(FUSED_BLOCK_SIZE, 4)
void q21_optimized_fused_kernel(
...
void runQ21TrueFused(SSBDataCompressed& data, QueryTiming& timing) {
    ...
    // Step 3: Warmup run
    // -------------------------------------------------------------------------
    q21_optimized_fused_kernel<<<num_partitions, FUSED_BLOCK_SIZE>>>(
        // Suppkey
    ...
    std::cout << "\n=== Q2.1 Results (Optimized True Fused) ===" << std::endl;
    ...
    timing.print("Q2.1 Optimized True Fused");
...
int main(int argc, char** argv) {
    ...
    std::cout << "=== SSB Q2.1 - Optimized True Fused Decompression ===" << std::endl;
