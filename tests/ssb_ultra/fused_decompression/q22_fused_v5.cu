/**
 * @file q22_fused_v5.cu
 * @brief SSB Q2.2 with L3 Native Format + Prefetch Strategy
 *
 * Query:
 ...
 *   - Part filter: brand range (260-267) instead of category
 *   - Supplier filter: ASIA instead of AMERICA
 */
...
constexpr uint32_t S_REGION_ASIA = 3;  // ASIA region code

// ============================================================================
// Main Fused Kernel V5 - Q2.2
// ============================================================================

__global__ void q22_fused_v5_kernel(
...
void runQ22FusedV5(SSBDataCompressedVertical& data) {
    ...
    build_part_ht_brand_range_kernel<<<(P_LEN + block_size - 1) / block_size, block_size>>>(
    ...
    for (int i = 0; i < 5; i++) {
        ...
        q22_fused_v5_kernel<<<num_tiles, WARP_SZ>>>(
...
int main(int argc, char** argv) {
    ...
    std::cout << "======================================================" << std::endl;
    std::cout << "SSB Q2.2 - L3 Native Format + Prefetch Strategy (V5)" << std::endl;
    std::cout << "======================================================" << std::endl;
