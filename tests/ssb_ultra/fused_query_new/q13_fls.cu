/**
 * @file q13_fls.cu
 * @brief SSB Q1.3 Implementation - Vertical-style FOR+BitPack
 *
 * Query:
 *   SELECT SUM(lo_extendedprice * lo_discount) AS revenue
 *   FROM lineorder
 *   WHERE lo_orderdate >= 19940204 AND lo_orderdate <= 19940210
...
// ============================================================================
// Q1.3 Query Constants
// ============================================================================

namespace {
constexpr int ORDERDATE_LO = 19940204;  // Week 6 of 1994 start (Feb 4)
constexpr int ORDERDATE_HI = 19940210;  // Week 6 of 1994 end (Feb 10)
constexpr int DISCOUNT_LO = 5;
constexpr int DISCOUNT_HI = 7;
    ...
    unsigned long long* __restrict__ revenue)
{
    ...
    // Predicate: >= 19940204 AND <= 19940210 (week 6)
    // ========================================
    {
...
void runQ13FLS(SSBDataFLS& data, FLSQueryTiming& timing) {
...
int main(int argc, char** argv) {
    ...
    std::cout << "=== SSB Q1.3 - Vertical Style FOR+BitPack ===" << std::endl;
    ...
    std::cout << "\n--- Running Q1.3 ---" << std::endl;
    FLSQueryTiming timing;
    runQ13FLS(data, timing);
