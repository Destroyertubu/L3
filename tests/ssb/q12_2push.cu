// SSB Query Q1.2 - Two-Stage + Predicate Pushdown
...
int main(int argc, char** argv) {
    cout << "========================================================================" << endl;
    cout << "  SSB Query Q1.2 - Two-Stage + Predicate Pushdown" << endl;
    cout << "========================================================================" << endl;
    cout << endl;
    ...
    for (int t = 0; t < num_trials; t++) {
        ...
        if (num_candidates > 0) {
            ...
            stage2_q12<uint32_t><<<grid_size, block_size>>>(
                d_candidate_indices,
                num_candidates,
        ...
        cout << "{" << R"("query":"Q1.2","optimization":"two_stage_predicate_pushdown","time_ms":)" << query_time
