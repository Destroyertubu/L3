...
void runQuery(int*                         lo_orderdate,
	...
	// Run - timing starts here for fair comparison
	...
	std::cout << "{\"query\":41,\"run\":0,\"time_metadata\":0,\"time_ht_build\":0,\"time_kernel\":" << time_query << ",\"time_total\":" << time_query << "}" << std::endl;
