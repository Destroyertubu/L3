/**
 * SSB Q3.3 - V13 (L3 V4 Vectorized Decoder)
 *
...
constexpr unsigned long long EXPECTED_TOTAL_Q33 = 214040808ULL;

__global__ void q33_fused_kernel_v15(
...
void runQ33FusedV13(SSBDataCompressedVertical& data, float time_h2d) {
    ...
    q33_fused_kernel_v15<<<num_partitions, V15_THREADS_PER_BLOCK>>>(
    ...
    for (int run = 0; run < RUNS; run++) {
        ...
        std::cout << "{\"query\":33,\"version\":\"v14\",\"run\":" << run
                  << ",\"time_h2d\":" << time_h2d
                  ...
                  << ",\"result\":" << total
                  << ",\"status\":\"" << (total == EXPECTED_TOTAL_Q33 ? "PASSED" : "FAILED") << "\"}" << std::endl;
    }
