// SSB Query 4.2 with L32 Compression - RANDOM ACCESS VERSION
...
int main(int argc, char** argv) {
    ...
    CompressedDataL3<uint32_t>* c_partkey_c = compressData(lo_partkey, 4096);
    CompressedDataL3<uint32_t>* c_revenue = compressData(lo_revenue, 4096);
    CompressedDataL3<uint32_t>* c_supplycost_c = compressData(lo_supplycost, 4096);
