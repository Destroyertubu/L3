// SSB Query 1.3 with Optimized L3 Compression
...
int main(int argc, char** argv) {
    cout << "========================================================================" << endl;
    cout << "  SSB Query 1.3 with Optimized L3 Compression" << endl;
    cout << "========================================================================" << endl;
    cout << endl;
    ...
    cout << "             AND lo_discount >= 5 AND lo_discount <= 7" << endl;
    ...
    for (int t = 0; t < num_trials; t++) {
        ...
        ssb_q13_kernel<<<grid_size, block_size>>>(
        ...
        cout << "{\"query\":13,\"time_ms\":" << query_time
