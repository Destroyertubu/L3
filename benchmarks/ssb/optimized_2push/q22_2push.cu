// SSB Query 2.2 with L32 Compression - RANDOM ACCESS VERSION (_2push version)
// Query: SELECT SUM(lo_revenue), d_year, p_brand1
//        FROM lineorder, date, part, supplier
//        WHERE lo_orderdate = d_datekey
//              AND lo_partkey = p_partkey
//              AND lo_suppkey = s_suppkey
//              AND p_brand1 BETWEEN 'MFGR#2221' AND 'MFGR#2228' (encoded as 221-228)
//              AND s_region = 'ASIA' (encoded as 2)
//        GROUP BY d_year, p_brand1
//
// Random Access Strategy:
// Stage 1: Scan lo_partkey, filter by p_brand1 BETWEEN 221 AND 228
...
// Stage 1: Scan lo_partkey and filter by p_brand1 BETWEEN 221 AND 228
template<typename T>
__global__ void ssb_q22_stage1_scan(
...
template<typename T>
__global__ void ssb_q22_stage2_random_access(
    ...
    if (d_supplier_ht[suppkey].s_region != 2) return;  // s_region = 'ASIA' (2)
...
int main(int argc, char** argv) {
    cout << "========================================================================" << endl;
    cout << "  SSB Query 2.2 with L32 Compression - RANDOM ACCESS VERSION" << endl;
    cout << "========================================================================" << endl;
    cout << endl;
    ...
    cout << "             AND p_brand1 BETWEEN 'MFGR#2221' AND 'MFGR#2228'" << endl;
    ...
    CompressedDataL3<uint32_t>* c_partkey = compressData(lo_partkey, 2048);
    CompressedDataL3<uint32_t>* c_suppkey = compressData(lo_suppkey, 2048);
    ...
    for (int t = 0; t < num_trials; t++) {
        ...
        ssb_q22_stage1_scan<uint32_t><<<grid_size, block_size>>>(
            c_partkey->d_self,
            d_part_ht,
            LO_LEN,
            d_candidates,
        ...
        if (h_candidate_count > 0) {
            ...
            ssb_q22_stage2_random_access<uint32_t><<<grid_size, block_size>>>(
                c_suppkey->d_self,
                c_orderdate->d_self,
                c_revenue->d_self,
                d_supplier_ht,
        ...
        cout << "{\"query\":22,\"time_query\":" << query_time
