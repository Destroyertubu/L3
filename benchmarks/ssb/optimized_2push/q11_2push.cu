// SSB Query Q1.1 - Two-Stage + Predicate Pushdown (with L32 variance-based compression)
// Automatically generated

#include "l32_adapter.hpp"
// #include "l3_ra_utils.cuh"  // Not needed - randomAccessDecompress is in l32_adapter.hpp
...
int main(int argc, char** argv) {
    cout << "========================================================================" << endl;
    cout << "  SSB Query Q1.1 - Two-Stage + Predicate Pushdown" << endl;
    cout << "========================================================================" << endl;
    cout << endl;
    ...
    // NOTE: Partition bounds are now computed automatically during compression
    // from learned models + delta statistics (Section 4.2.2 of paper)
    // No need for separate bounds computation!
    ...
    for (int t = 0; t < num_trials; t++) {
        ...
        cout << "{" << R"("query":"Q1.1","optimization":"two_stage_predicate_pushdown","time_ms":)" << query_time
